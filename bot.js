  ...
  if(m.content === "lb.stats") {
	...
	if(m.content.startsWith("lb.kick")) {
		...
		if (m.member.hasPermission("KICK_MEMBERS")) {
			...
			m.reply('You do not have the permission to kick someone!')
		}
  }
